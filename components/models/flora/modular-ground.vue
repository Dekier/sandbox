...
let oldInstancedMeshGroundOneSide = null;
let oldInstancedMeshGroundOneSide2 = null;
let oldInstancedMeshGroundCornerSide = null;
let oldInstancedMeshGroundCornerSide2 = null;
let oldInstancedMeshGroundTwoSide = null;
let oldInstancedMeshGroundTwoSide2 = null;
let oldInstancedMeshGroundThreeSide = null;
let oldInstancedMeshGroundThreeSide2 = null;
let oldInstancedMeshGroundZero = null;
const setIntancesMesh = () => {
  ...
  for (let i = 0; i < groundTwoSideList.length; i++) {
    ...
    if (groundTwoSideList[i].side === "left-right") {
      ...
      dummyTwoSide.rotation.y = Math.PI;
    }
  ...
  oldInstancedMeshGroundOneSide = instancedMeshGroundOneSide;
  oldInstancedMeshGroundOneSide2 = instancedMeshGroundOneSide2;
  oldInstancedMeshGroundCornerSide = instancedMeshGroundCornerSide;
  oldInstancedMeshGroundCornerSide2 = instancedMeshGroundCornerSide2;
  oldInstancedMeshGroundTwoSide = instancedMeshGroundTwoSide;
  oldInstancedMeshGroundTwoSide2 = instancedMeshGroundTwoSide2;
  oldInstancedMeshGroundThreeSide = instancedMeshGroundThreeSide;
  oldInstancedMeshGroundThreeSide2 = instancedMeshGroundThreeSide2;
  oldInstancedMeshGroundZero = instancedMeshGroundZero;
};

const clearData = () => {
  if (oldInstancedMeshGroundOneSide) {
    oldInstancedMeshGroundOneSide.geometry.dispose();
    oldInstancedMeshGroundOneSide.material.dispose();
    scene.value.remove(oldInstancedMeshGroundOneSide);
  }

  if (oldInstancedMeshGroundOneSide2) {
    oldInstancedMeshGroundOneSide2.geometry.dispose();
    oldInstancedMeshGroundOneSide2.material.dispose();
    scene.value.remove(oldInstancedMeshGroundOneSide2);
  }

  if (oldInstancedMeshGroundCornerSide) {
    console.log("lol");
    oldInstancedMeshGroundCornerSide.geometry.dispose();
    oldInstancedMeshGroundCornerSide.material.dispose();
    scene.value.remove(oldInstancedMeshGroundCornerSide);
  }

  if (oldInstancedMeshGroundCornerSide2) {
    oldInstancedMeshGroundCornerSide2.geometry.dispose();
    oldInstancedMeshGroundCornerSide2.material.dispose();
    scene.value.remove(oldInstancedMeshGroundCornerSide2);
  }

  if (oldInstancedMeshGroundTwoSide) {
    oldInstancedMeshGroundTwoSide.geometry.dispose();
    oldInstancedMeshGroundTwoSide.material.dispose();
    scene.value.remove(oldInstancedMeshGroundTwoSide);
  }

  if (oldInstancedMeshGroundTwoSide2) {
    oldInstancedMeshGroundTwoSide2.geometry.dispose();
    oldInstancedMeshGroundTwoSide2.material.dispose();
    scene.value.remove(oldInstancedMeshGroundTwoSide2);
  }

  if (oldInstancedMeshGroundThreeSide) {
    oldInstancedMeshGroundThreeSide.geometry.dispose();
    oldInstancedMeshGroundThreeSide.material.dispose();
    scene.value.remove(oldInstancedMeshGroundThreeSide);
  }

  if (oldInstancedMeshGroundThreeSide2) {
    oldInstancedMeshGroundThreeSide2.geometry.dispose();
    oldInstancedMeshGroundThreeSide2.material.dispose();
    scene.value.remove(oldInstancedMeshGroundThreeSide2);
  }

  if (oldInstancedMeshGroundZero) {
    oldInstancedMeshGroundZero.geometry.dispose();
    oldInstancedMeshGroundZero.material.dispose();
    scene.value.remove(oldInstancedMeshGroundZero);
  }
};
